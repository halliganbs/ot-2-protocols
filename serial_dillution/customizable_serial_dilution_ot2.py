def get_values(*names):
    import json
    _all_values = json.loads("""{"pipette_type":"p300_multi_gen2","tip_type":0,"trough_type":"nest_12_reservoir_15ml","plate_type":"corning_96_wellplate_360ul_flat","dilution_factor":1.5,"num_of_dilutions":10,"total_mixing_volume":150,"tip_use_strategy":"never"}""")
